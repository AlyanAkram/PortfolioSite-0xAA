...
const LINES = [
  ...
  { text: '─────────────────────────────────────────', cls: 'dim', delay: 120 },
  { text: 'POST check...', cls: '', delay: 200 },
  { text: '  [OK] CPU: Intel i9 × 16 cores', cls: 'dim', delay: 340 },
  { text: '  [OK] RAM: 64GB DDR5', cls: 'dim', delay: 460 },
  { text: '  [OK] GPU: RTX 4090 — for training models obviously', cls: 'dim', delay: 580 },
  { text: '', cls: '', delay: 700 },
  { text: 'Loading kernel modules...', cls: '', delay: 760 },
  { text: '  [OK] python3.12 ................... loaded', cls: 'dim', delay: 860 },
  { text: '  [OK] fastapi / uvicorn ............ loaded', cls: 'dim', delay: 960 },
  { text: '  [OK] react + vite ................. loaded', cls: 'dim', delay: 1060 },
  { text: '  [OK] openai_sdk ................... loaded', cls: 'dim', delay: 1160 },
  { text: '  [OK] tailwindcss .................. loaded', cls: 'dim', delay: 1260 },
  { text: '', cls: '', delay: 1360 },
  { text: 'Mounting filesystems...', cls: '', delay: 1440 },
  { text: '  /dev/projects → /home/aa/work ........ done', cls: 'dim', delay: 1560 },
  { text: '  /dev/skills   → /usr/share/aa ........ done', cls: 'dim', delay: 1680 },
  { text: '', cls: '', delay: 1780 },
  { text: 'Network interfaces:', cls: '', delay: 1840 },
  { text: '  eth0  192.168.0.1  ■ ONLINE', cls: 'dim', delay: 1940 },
  { text: '  tun0  vpn0         ■ SECURE', cls: 'dim', delay: 2040 },
  { text: '', cls: '', delay: 2120 },
  { text: '⚠  WARNING: coffee.service — low caffeine detected', cls: 'warn', delay: 2200 },
  { text: '', cls: '', delay: 2320 },
  { text: 'Starting desktop environment...', cls: 'bright', delay: 2420 },
  { text: '__PROGRESS__', cls: '', delay: 2540 },
  { text: '', cls: '', delay: 3480 },
  { text: '✓ BOOT COMPLETE — Welcome, visitor.', cls: 'bright', delay: 3560 },
]
